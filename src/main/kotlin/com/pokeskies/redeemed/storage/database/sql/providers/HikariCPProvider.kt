...
import com.pokeskies.redeemed.storage.database.sql.ConnectionProvider
import com.zaxxer.hikari.HikariConfig
import com.zaxxer.hikari.HikariDataSource
import java.sql.Connection
import java.sql.SQLException

abstract class HikariCPProvider(private val storageConfig: StorageSettings): ConnectionProvider {
    ...
    override fun init() {
        ...
        config.poolName = "redeemed-${getDriverName()}"

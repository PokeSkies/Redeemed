...
object Utils {
    ...
    fun printDebug(message: String?, bypassCheck: Boolean = false) {
        if (bypassCheck || ConfigManager.CONFIG.debug)
            Redeemed.LOGGER.info("[${Redeemed.MOD_NAME}] DEBUG: $message")
    }

    fun printError(message: String?) {
        Redeemed.LOGGER.error("[${Redeemed.MOD_NAME}] ERROR: $message")
    }

    fun printInfo(message: String?) {
        Redeemed.LOGGER.info("[${Redeemed.MOD_NAME}] $message")
    }
